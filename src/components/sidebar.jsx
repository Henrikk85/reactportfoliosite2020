        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{ backgroundImage: 'url(images/hk_2019_v2.jpg)' }} />
            ...
            <nav id="colorlib-main-menu">
              <ul>
               <li><a href="http://funktech.ee" target="_blank" rel="noopener noreferrer"><i className="icon-home"></i></a></li> 
